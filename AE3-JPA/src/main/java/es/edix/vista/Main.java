...
public class Main {
	...
	public static void main(String[] args) {
		...
		try {
			...
			System.out.println("Error en la creacion: " + e.getLocalizedMessage());
			System.exit(1);
		}
		...
		try (Scanner sc = new Scanner(System.in)) {
			...
			do {
				...
				//MOSTRAR AUTORES DE ALTA CON LIBROS
				case 2:
